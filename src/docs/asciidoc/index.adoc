...
=== 마이페이지 받은 후기 조회(최초 요청)

.Request
include::{snippets}/AccompanyControllerTest/getReviewsFirst/http-request.adoc[]
include::{snippets}/AccompanyControllerTest/getReviewsFirst/query-parameters.adoc[]

.Response
include::{snippets}/AccompanyControllerTest/getReviewsFirst/http-response.adoc[]
include::{snippets}/AccompanyControllerTest/getReviewsFirst/response-fields.adoc[]

=== 마이페이지 받은 후기 조회(이후 요청)
최초 요청 api와는 cursorId 유무의 차이가 있습니다

.Request
include::{snippets}/AccompanyControllerTest/getReviewsAfterFirst/http-request.adoc[]
include::{snippets}/AccompanyControllerTest/getReviewsAfterFirst/query-parameters.adoc[]

.Response
include::{snippets}/AccompanyControllerTest/getReviewsAfterFirst/http-response.adoc[]
include::{snippets}/AccompanyControllerTest/getReviewsAfterFirst/response-fields.adoc[]
